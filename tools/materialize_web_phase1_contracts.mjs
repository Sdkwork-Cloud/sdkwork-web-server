...
const surfaces = [
  {
    ...
    routeManifestPath:
      "sdks/_route-manifests/app-api/sdkwork-router-webserver-app-api.route-manifest.json",
    crateDir: "crates/sdkwork-router-webserver-app-api",
    manifestFn: "app_route_manifest",
    packageName: "sdkwork-router-webserver-app-api",
    surface: "app-api",
  ...
  },
  {
    ...
    routeManifestPath:
      "sdks/_route-manifests/backend-api/sdkwork-router-webserver-backend-api.route-manifest.json",
    crateDir: "crates/sdkwork-router-webserver-backend-api",
    manifestFn: "backend_route_manifest",
    packageName: "sdkwork-router-webserver-backend-api",
    surface: "backend-api",
