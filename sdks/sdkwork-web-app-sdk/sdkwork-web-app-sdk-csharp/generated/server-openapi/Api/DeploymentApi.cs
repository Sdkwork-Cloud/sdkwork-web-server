...
namespace SDKWork.Web.AppSdk.Api
{
    public class DeploymentApi
    {
        ...
        /// 获取部署历史
        /// </summary>
        public async Task<SDKWork.Web.AppSdk.Models.DeploymentPage?> SitesDeploymentsListAsync(string siteId, int? page = null, int? pageSize = null, int? status = null)
        {
        ...
        /// 发起部署
        /// </summary>
        public async Task<SDKWork.Web.AppSdk.Models.DeploymentResponse?> SitesDeploymentsCreateAsync(string siteId, SDKWork.Web.AppSdk.Models.CreateDeploymentRequest body)
        {
            return await _client.PostAsync<SDKWork.Web.AppSdk.Models.DeploymentResponse>(ApiPaths.AppPath($"/sites/{SerializePathParameter(siteId, new PathParameterSpec("siteId", "simple", false))}/deployments"), body, null, null, "application/json");
        }

        /// <summary>
        /// 获取部署详情
        /// </summary>
        public async Task<SDKWork.Web.AppSdk.Models.DeploymentResponse?> SitesDeploymentsRetrieveAsync(string siteId, string deploymentId)
        {
            return await _client.GetAsync<SDKWork.Web.AppSdk.Models.DeploymentResponse>(ApiPaths.AppPath($"/sites/{SerializePathParameter(siteId, new PathParameterSpec("siteId", "simple", false))}/deployments/{SerializePathParameter(deploymentId, new PathParameterSpec("deploymentId", "simple", false))}"));
        }

        /// <summary>
        /// 回滚部署
        /// </summary>
        public async Task<SDKWork.Web.AppSdk.Models.DeploymentResponse?> SitesDeploymentsRollbackAsync(string siteId, string deploymentId)
        {
            return await _client.PostAsync<SDKWork.Web.AppSdk.Models.DeploymentResponse>(ApiPaths.AppPath($"/sites/{SerializePathParameter(siteId, new PathParameterSpec("siteId", "simple", false))}/deployments/{SerializePathParameter(deploymentId, new PathParameterSpec("deploymentId", "simple", false))}/rollback"), null);
        }
