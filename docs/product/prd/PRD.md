...
- [REQ-2026-0024 Upstream TLS identity and pool isolation](../requirements/REQ-2026-0024-upstream-tls-identity-pool-isolation.md) - in-progress private trust, mutual TLS identity, TLS-version bounds, fail-closed generation construction, and security-context pool isolation.
